                ...
                <div class="row">
                    ...
                    <div class="rightSide">
                        <form method="POST" action="" class="loginForm" autocomplete="off">
                            ...
                            <a href="PAGEforgetpass.php" class="lupaPass">Lupa password?</a><style>.lupaPass {text-decoration: none;color:blue;margin:5px 0; display:inline-block;}.lupaPass:hover {color:#71499C}</style>
                            <!-- Remember me -->
                            <div class="remember">
