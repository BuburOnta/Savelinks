                        ...
                        <form method="POST" action="" class="registForm" autocomplete="off">
                            ...
                            <?php endif; ?>
                                ...
                                <div class="regist-group username">
                                    ...
                                    <input type="text" name="username" id="username" value="Bedul">
                                ...
                                <div class="regist-group email">
                                    ...
                                    <input type="email" name="email" id="email" value="lah.ontaks@gmail.com">
                                ...
                                <div class="regist-group confirm_password">
                                    ...
                                    <input type="password" name="confirm_password" id="confirm_password" value="123">
